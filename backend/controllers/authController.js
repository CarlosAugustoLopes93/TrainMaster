...
const registerUser = async (req, res) => {
  ...
  if (!name || !email || !password || !peso || !altura || !telefone || !experiencia) {
  ...
  try {
    ...
    const validUserTypes = ['admin', 'trainer', 'user']; // Exemplo
...
module.exports = {
  registerUser,
  loginUser // Não se esqueça de exportar o loginUser também
};
